<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationFormExample.aspx.cs" Inherits="WebFormTopics.ASP_TOPICS._17___RegistrationForm.RegistrationFormExample" %>
...
<body>
    ...
    <table class="auto-style1">  
        ...
        <tr>  
            <td class="auto-style2"><asp:Label ID="ShowEmailIDLabel" runat="server" ></asp:Label>
            </td>  
            <td>  
